 ...
 <body>
 	...
 	<?php 
		...
		if(!empty($_POST['kata']))
		{
			$input = "INSERT into tbstem set Term='$teksAsli', Stem='$stemming'";
			//$result = mysql_query($con, $input);
			...
			{
				 echo "<script> alert('data sudah ada'); window.location='stemming.php';</script>";
...
function cekKamus($kata){ 
	...
	include "../koneksi.php";
	$sql = mysqli_query($con, "SELECT * from dictionary where word ='$kata' LIMIT 1");
